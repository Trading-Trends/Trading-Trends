...
GRANT USAGE ON SCHEMA s_corporate TO crp;
GRANT SELECT ON ALL TABLES IN SCHEMA s_corporate TO crp;
ALTER DEFAULT PRIVILEGES IN SCHEMA s_corporate GRANT SELECT ON TABLES TO crp;
